        ...
        <div className="FirstSecMain">
          <div className="FirstSecColumn">
            ...
            <div className="FirstSecElement">
              ...
              <p className="bits_are_better_content">
                A dry tablet means we can use less-harmful ingredients and still
                protect your teeth.
              </p>
            </div>
            ...
            <div className="FirstSecElement">
              ...
              <p className="bits_are_better_content">
                Our tablets leave less mess in your sink because no glycerine –
                what makes most toothpaste, paste – means no sticky goop.
              </p>
            </div>
          </div>
          ...
          <div className="FirstSecColumn">
            <div className="FirstSecElement">
              ...
              <p className="bits_are_better_content">
                No more toothpaste explosions in your bag. Just throw a few Bits
                in your pack and you’re good to go
              </p>
            </div>
            ...
            <div className="FirstSecElement">
              ...
              <p className="bits_are_better_content">
                Infinitely refillable with no plastic toothpaste tubes, our Bits
                are better for our earth and oceans.
              </p>
            </div>
            ...
            <div className="FirstSecElement">
              ...
              <p className="bits_are_better_content">
                The top of a toothpaste tube can transfer bacteria from your
                partners brush to your mouth. Our Bits can stop the spread.
              </p>
            </div>
          </div>
        </div>
