...
const FullCards = memo(({ cards, setCards, addItem }) => {
  return (
    <>
      {cards.map((card) => (
        <div key={card.id} className="cards">
          <div className="preview">
            ...
            <FCardsHover cards={cards} card={card} setCards={setCards} />
          </div>
...
const FCardsHover = ({ card, cards, setCards }) => {
  return (
