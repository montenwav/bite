...
export function Bag({ bagRef }) {
  ...
  return (
    <>
      <div className="bag">
        <div onClick={handleExitBtn} className="bag_bg"></div>
        <BagContainer bagRef={bagRef} handleExitBtn={handleExitBtn} />
      </div>
    </>
  );
}
...
const middleBagArr = [
  {
    ...
    description:
      "Everything you need to reset your routine and go plastic-free.",
  },
  {
    ...
    description:
      "Our toothpaste alternative, made without harsh chemicals, plastics or fluoride.",
  },
  {
