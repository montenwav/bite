...
const FirstTypeQuestion = ({
  ...
  return (
    <div className="toggle_item">
      <div onClick={() => setToggleId(id)} className="header_container">
        <h4>{title}</h4>
        <svg
          className="cervon"
      ...
      <div className={`content_container ${toggleId === id && "active"}`}>
        <p>{p_1}</p>
        <p>{p_2}</p>
        <p>{p_3}</p>
      </div>
  ...
  return (
    <div className="toggle_item">
      ...
      <div className={`content_container ${toggleId == id ? "active" : ""}`}>
        ...
        <ol>
          <li>
            <p className="ol_p">{li_1}</p>
          </li>
          <li>
            <p className="ol_p">{li_2}</p>
          </li>
          <li>
            <p className="ol_p">{li_3}</p>
          </li>
        </ol>
      </div>
      <div className="hr"></div>
