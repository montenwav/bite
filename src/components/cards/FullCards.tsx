...
const Preview = ({ card, cards, setCards }: FullCardsFunctionArgs) => {
  return (
...
const FullCardsHover = ({ card, cards, setCards }: FullCardsFunctionArgs) => {
  return (
...
const DeliversEveny = ({ card }: { card: cardsObjType }) => {
  return (
